...
//					dataFim = sdt.format(new Date());
                ...
                case 5:
                    ...
                    System.out.println("Digite a apolice do Seguro desse veículo? : ");
                    String apoliceSeguroVeiculo = sc.next();
                    System.out.println("Digite o valor do Seguro: ");
                    double valorSeguroVeiculo = sc.nextDouble();
                    System.out.println("Digite a data de início do Seguro: ");
                    String dataInicioSeguroVeiculo = sc.next();
                    System.out.println("Digite a data de término do Seguro: ");
                    String dataFimSeguroVeiculo = sc.next();
                    System.out.println("Qual o tipo de cobertura do Seguro? ");
                    String tipoCoberturaSeguroVeiculo = sc.next();
                    System.out.println("Histórico de Sinistro: ");
                    String historicoSinistroSeguroVeiculo = sc.next();
                    System.out.println("Qual é a franquia? ");
                    String franquiaSeguroVeiculo = sc.next();

                    // Convertendo a data para LocalDate
                    LocalDate dataInicialSeguroVeiculo = LocalDate.parse(dataInicioSeguroVeiculo, formataData);
                    LocalDate dataFinalSeguroVeiculo = LocalDate.parse(dataFimSeguroVeiculo, formataData);

                    seguroModel = new SeguroModel(apoliceSeguroVeiculo, valorSeguroVeiculo, dataInicialSeguroVeiculo,
                            dataFinalSeguroVeiculo, tipoCoberturaSeguroVeiculo, historicoSinistroSeguroVeiculo, franquiaSeguroVeiculo);
                    assert false;
                    veiculoModel = new VeiculoModel(placaVeiculo, corVeiculo, marcaVeiculo, categoriaVeiculo, chassiVeiculo, modeloVeiculo, seguroModel);
                ...
                case 6:
                    ...
                    System.out.println("Digite o data de inicio da locação: ");
                    String dataIncioLocacao = sc.nextLine();
                    System.out.println("Digite o data de fim da locação: ");
                    String dataFimLocacao = sc.nextLine();
                    System.out.println("O cliente é PF ou PJ? ");
                    String checkCliente = sc.nextLine().toUpperCase();
